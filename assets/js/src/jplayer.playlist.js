...
;(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			if ( ! media.download ) {
				if ( media.itunes ) {
					listItem+="<a target='_blank' title='"+WolfjPlayerParams.iTunesText+"' href='"+media.itunes+"' class='itunes'></a>";
				}

				if ( media.amazon ) {
					listItem+="<a target='_blank' title='"+WolfjPlayerParams.amazonText+"' href='"+media.amazon+"' class='amazon'></a>";
				}

				if ( media.buy ) {
					listItem+="<a target='_blank' title='"+WolfjPlayerParams.buyNowText+"' href='"+media.buy+"' class='buy'></a>";
				}
			}

			else{
				listItem+="<a class='free-dl' title='"+WolfjPlayerParams.downloadText+"' target='_blank' href='"+media.download+"'></a>";
